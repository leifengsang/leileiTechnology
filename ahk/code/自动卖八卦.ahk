...
openBox(){
  ...
  if(alertExists()){
    ; 有多个箱子 需要选择个数
    awardCount:=getBoxAwardNum()
    if(awardCount = 1){
      sendControl("{2}")
      sendControl("{0}")
      sleepTime:=1000 + 400*20
      Sleep 100
    }else if(awardCount = 3){
      sendControl("{7}")
      sleepTime:=1000 + 400*7
      Sleep 100
    }else{
      sendControl("{4}")
      sleepTime:=1000 + 400*4
      Sleep 100
    }
    sendControl("{enter}")
  }
...
findBox(){
  Text:="|<>*72$29.TzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzyTDzzyzXzzwzUzztzkTztzsDzts27zvX1Xzn4Hbzo0tjzcAETzs04zzk09zxE03zsE07zmE0Tzk03TzU0MzzU01zz007zy00w"
...
getBoxAwardNum(){
  ...
  Text:="|<>*74$29.zDs2ryTxhi01uPQ0306znzhhzXyHPyLxabxbniDnbk0zDbU1szbwzXzY00U"
  if(FindText(X, Y, 0, 0, A_ScreenWidth, A_ScreenHeight, 0.1, 0.1, Text)){
    result:=5
  }
  
  Text:="|<>*75$28.yzzzztz0Kk0DPP00xBhtv06rbjPPSStBhtvgorbgvX00s0TtzU1zbztzyTk03vzzzs"
  if(FindText(X, Y, 0, 0, A_ScreenWidth, A_ScreenHeight, 0.2, 0.2, Text)){
    result:=3
  }
...
findItem(){
  ...
  result:=[]
   ; 黒鳍1-8
   ; 1
  ; Text:="|<>*100$40."

  ; arr:=FindText(X, Y, 0, 0, A_ScreenWidth, A_ScreenHeight, globalErr, globalErr, Text)
  ; if(arr){
    ; result.Push(arr*)
  ; }
  
  ; 2
  ; Text:="|<>*98$47."
  ...
  ; 3
  ; Text:="|<>*100$48."
  ...
  ; 4
  ; Text:="|<>*91$49."
  ...
  ; 5
  ; Text:="|<>*120$39."
  ...
  ; 6
  ; Text:="|<>*104$46."
  ...
  ; 7
  ; Text:="|<>*100$46."
  ...
  ; 8
  ; Text:="|<>*111$45."
  ...
  ; 万魂1-8
  ; 1
  Text:="|<>*97$41.k000001U00000DU0T2Q0z107U0sy0000Thw2263v3s01kxXDU0k6ADy00008js00w0k3w03u1c7s00MTGTk00VyvzU82Dzvz008zzzzs0Xzzjzq07zrzzx0z7bzzzVy3zzzvHp3zzzozA3zzzsNyTzzznvmzzzzc7zzzzz0Bbzzzy1vDzzzz2DTzzzw6/zzzztkzzzzzyUTzzzzx4zzzzzsRzzzzzuzzzzzzvzzzzzznzzzzzyTzzzU"
  ...
  ; 2
  Text:="|<>*109$46."
  ...
  ; 3
  Text:="|<>*93$50."
  ...
  ; 4
  Text:="|<>*110$50."
  ...
  ; 5
  Text:="|<>*104$41."
  ...
  ; 6
  Text:="|<>*103$46."
  ...
  ; 7
  Text:="|<>*111$46."
  ...
  ; 8
  Text:="|<>*123$43."
