...
; 分解
/*
@param again 部分拆解流程可能会二次产出需要拆解的物品，为了防止背包满了，需要再次分解
@param exitWhenFailed 再次分解时检测到没有物品不需要结束流程，而是重新开箱子
*/
breakDown(again:=true, exitWhenFailed:=true){
  if(!startFlag){
    return
  }
...
findBox(){
  Text:="|<>*86$28.ztzzzyDzzzWbzzwTyp7Vzw0wDzq0XzzdkTzyDlzztz4XbDyk0IzzU0A1js0007w0003U0000U001s0600U060280QkME0DzkkIDyYE0Dy008"
  return FindText(X, Y, 0, 0, A_ScreenWidth, A_ScreenHeight, 0.2, 0.2, Text)
}

alertExists(){
  Text:="|<>*115$32.zztzzzzwDzzzyNzzzzDDzzzbtzzznzDzztztzzwzzDzyS3tzzDkzDzbwDtznz3zDtzkztwzwDzCTz3ztDzkzz3zwDzmTz3ztnzlzwyTyTyTnzbzDyTzzbznyTnzyTbtzznzwzzyTyTzznzDzzyTbzzznnzzzyNzzzzkzzzzyTzy"
  if(FindText(X, Y, 0, 0, A_ScreenWidth, A_ScreenHeight, 0.2, 0.2, Text)){
    return true
  }else{
    return false
  }
...
confirmExists(){
  Text:="|<>*104$54.zzzzzxzzz07yzzAz21zryzzSyHhjryzySQnBDry0QzS0FDryzs0Chr01yzn0G1LzxyzzjSU1zxyzzjSgr05yzzDS1rzxyzzDSg0ztyzyTShrz3008kQnrzjzzzzzzzU"
  if(FindText(X, Y, 0, 0, A_ScreenWidth, A_ScreenHeight, 0.1, 0.1, Text)){
    return true
  }else{
    return false
  }
...
findItem(){
  ...
  Text:="|<>*50$52.zzVrsywu3zy3BnvrcDzu4DDry0zzzQStPQ3yTwKPzBUD00TVztY0y1UuXcSk3wDkYS1z0C4RqYshw0z7zVk7zU3yTyt2OQ0DXzt23X00z7zUtCA03xwATask0D3nESNW00STEFt0M01zy1WU1000yk3+040006EQU0U000k3k0200061y00E000kTU000006bk000000Ow0000007ZU000000Tg0000007pU000000Tw0000002"
  arr:=FindText(X, Y, 0, 0, A_ScreenWidth, A_ScreenHeight, 0.2, 0.2, Text)
  if(arr){
    result.Push(arr*)
  }
  
  Text:="|<>*57$50."
  arr:=FindText(X, Y, 0, 0, A_ScreenWidth, A_ScreenHeight, 0.2, 0.2, Text)
  if(arr){
    result.Push(arr*)
  }
