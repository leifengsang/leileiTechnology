...
start(){
  actionStatus:=0
  SetTimer turnEntryDir, 10
	return
}
	
end(){
  SetTimer turnEntryDir, Off
  SetTimer delayCheckEntered, Off
...
; 进门前的方向
checkEntryDir(){
  Text:="|<>*186$25.zzzwzzzszzzkTzzUTzz0Dzw0Dzs07zk07zk03zU03z001y001z000Ts007zU03zw00zzU0Dzy07zzk1zzy0zzzsDzzz7zzzt"
  if(FindText(X, Y, A_ScreenWidth - 750, 0, A_ScreenWidth, 750, 0.1, 0.1, Text)){
		return true
	}else{
		return false
	}
...
forwardAndTurnAfterEnter(){
  ...
  showTooltip("forward and turn after enter succ")
  actionStatus:=3
  SetTimer turnRightDir, 10
}
...
turnRightDir(){
  ...
  if(checkRightDir()){
    showTooltip("turn right dir succ")
    actionStatus:=4
    SetTimer turnRightDir, Off
...
; 判断有没有轻功条
runBarExists(){
	PixelSearch x1, y1, A_ScreenWidth / 2 - 200, A_ScreenHeight - 250, A_ScreenWidth / 2 + 200, A_ScreenHeight - 150, "0x50f6b6", 10, Fast RGB
	return !ErrorLevel
}
...
bossExists(){
  ; 检测boss等级
  Text:="|<>*74$24.sTy7U7s3X7kl7XltDnnzznXzzXXzz7U7wDU3sDVlw7XtzXXsznXszlXsDnXt7nnt7XllU7s3sDw7U"
  if(FindText(X, Y, A_ScreenWidth / 2 - 500, 155, A_ScreenWidth / 2, 200, 0.2, 0.2, Text)){
		return true
	}else{
		return false
	}
...
collectable(){  
  Text:="|<>*98$48."
